...
- [ ] **Content:** Add the missing articles to Substack RSS feed. But try to add them back-dated on their actual post date.

## 🔧 Infrastructure
- [ ] **CI/CD:** Fix the Netlify build settings (Change build command to `npm run build`)
- [ ] **Domain:** Verify `pratapaditya.com` points to the new Netlify build